...
### 1.8 문항은 「검색하면 아~ 할 정도」여야 한다

주제를 고른 사람이 **검색 없이 떠올릴 수 있는가**가 기준이다.
마이너한 항목은 문항 수를 늘려 주지만 그 라운드를 통째로 죽인다 —
아무도 못 맞히면 채팅이 멈추고, 멈춘 방은 사람이 나간다.

```
넣는다    슬램덩크 · 스타크래프트 · IMF · 삼일운동 · 손흥민
안 넣는다  악튜러스 · 015비 · 아관파천 · 트리플더블 · 흑자도산
```

세부 주제(축구·야구·농구·드라마·영화·애니·게임)를 고른 사람에게는
그 안에서 조금 더 깊이 들어가도 된다. 다만 **종합 주제에는 대중적인 것만.**

### 1.9 인용을 쓰지 않는다

가사·시·소설은 물론이고 **명대사·광고 카피도 그대로 옮기지 않는다.**
짧은 문구는 법적으로 대체로 문제가 없지만, 인용을 아예 두지 않으면
판단할 일 자체가 사라진다 — 콘텐츠가 계속 늘어날 자리라 그 편이 낫다.

```
안 쓴다   가사 · 대사 · 광고 카피 · 작품 제목 인용
쓴다     사실 · 사건 · 물건 · 행동에 대한 자체 서술
```

작품을 가리켜야 할 때는 **정답 단어로** 두고(「슬램덩크」가 정답),
힌트에서는 서술한다 — "북산고가 나오는 농구 만화".

> 08 문서 §3

### 1.10 문항은 검증을 통과한 것만 넣는다
