...
export const SAMPLE_QUESTIONS: NonEmptyArray<OxQuestion> = [
  ...
  { text: '떡볶이는 고추장 양념으로 만든다', topic: 'food', answer: true },
  { text: '삼계탕은 복날에 먹는 음식이다', topic: 'food', answer: true },
  { text: '짜장면은 한국에서 만들어진 중화요리다', topic: 'food', answer: true },
  { text: '김치는 원래 고춧가루를 넣어 담갔다', topic: 'food', answer: false },
  { text: '송편은 설날에 먹는 떡이다', topic: 'food', answer: false },
  { text: '한라산은 남한에서 가장 높은 산이다', topic: 'place', answer: true },
  { text: '첨성대는 경주에 있다', topic: 'place', answer: true },
  { text: '에펠탑은 런던에 있다', topic: 'place', answer: false },
  { text: '제주도는 우리나라에서 가장 큰 섬이다', topic: 'place', answer: true },
  { text: '독도는 서해에 있다', topic: 'place', answer: false },
  { text: '펭귄은 남극에 산다', topic: 'nature', answer: true },
  { text: '무궁화는 우리나라 국화다', topic: 'nature', answer: true },
  { text: '박쥐는 새다', topic: 'nature', answer: false },
  { text: '은행나무는 가을에 노랗게 물든다', topic: 'nature', answer: true },
  { text: '돌고래는 어류다', topic: 'nature', answer: false },
  { text: '태양은 별이다', topic: 'science', answer: true },
  { text: '목성은 태양계에서 가장 큰 행성이다', topic: 'science', answer: true },
  { text: '빛은 소리보다 빠르다', topic: 'science', answer: true },
  { text: '물은 100도에서 끓는다', topic: 'science', answer: true },
  { text: '달은 스스로 빛을 낸다', topic: 'science', answer: false },
  { text: '작심삼일은 마음먹은 것이 사흘 간다는 뜻이다', topic: 'saying', answer: true },
  { text: '일석이조는 한 번에 두 가지를 얻는다는 뜻이다', topic: 'saying', answer: true },
  { text: '청출어람은 스승이 제자보다 낫다는 뜻이다', topic: 'saying', answer: false },
  { text: '설날에는 떡국을 먹는다', topic: 'holiday', answer: true },
  { text: '동지에는 팥죽을 먹는다', topic: 'holiday', answer: true },
  { text: '단오는 음력 8월에 있다', topic: 'holiday', answer: false },
  { text: '정월대보름에는 부럼을 깬다', topic: 'holiday', answer: true },
]
