...
export const SAMPLE_YEARS: NonEmptyArray<YearEntry> = [
  ...
  },
  {
    ...
    hints: [
      ...
      '정부가 IMF에 구제금융을 요청했다',
      '영화 PC통신을 소재로 한 영화가 개봉했다',
      'H.O.T 가 데뷔한 이듬해다',
      '금 모으기 운동이 시작되기 직전 해다',
    ],
    card: {
      prices: ['자장면 2,500원', '지하철 400원', '최저임금 시급 1,485원'],
      events: ['IMF 구제금융 요청', '영화 PC통신 소재 영화 개봉', '프로야구 우승 — 해태 타이거즈'],
    },
  },
  {
    year: 1998,
    ...
    hints: [
      ...
      '침몰하는 배를 다룬 외화가 극장에 걸렸다',
      '일본 대중문화가 처음으로 개방됐다',
      '국내 최초 그래픽 머드가 서비스되던 시기다',
    ],
    card: {
  ...
  },
  {
    ...
    card: {
      ...
      events: ['말춤이 세계적으로 유행', '런던 올림픽', '제18대 대통령 선거'],
    },
  },
  {
    year: 1997,
    ...
    card: {
      ...
      events: ['영화 PC통신 소재 영화 개봉', '드라마 재벌과 신인을 다룬 드라마', 'IMF 구제금융 요청'],
    },
  },
  {
    year: 1999,
    ...
    card: {
      ...
      events: ['Y2K 대비 소동', '영화 한국 영화 흥행 기록 경신', '초고속 인터넷 보급 확대'],
    },
  },
  {
    year: 1995,
